---
title: "{{currentYear}} NCFL Speech Events Live Doc"
mustache:
  - vars.yaml
---
...
| Start Time   | (All times in Eastern)               |
| ------------ | ------------------------------------ |
| **Saturday** |                                      |
| 8:00 AM      | EX 1 (Draw)                          |
...
Official rules and suggested judging criteria for each event can be found at
<https://www.ncfl.org/events.html/>
